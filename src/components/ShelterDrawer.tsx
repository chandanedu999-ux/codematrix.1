    ...
    >
      ...
      >
        ...
        <div className="sticky bottom-0 bg-[#FFFFFF] border-t border-[#E2E8F0] p-4 space-y-2">
          ...
          <a
            id="drawer-google-maps-directions-btn"
            href={`https://www.google.com/maps/dir/?api=1&destination=${shelter.lat},${shelter.lng}&travelmode=driving`}
            target="_blank"
            rel="noopener noreferrer"
            className="w-full flex items-center justify-center gap-2 bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 py-2.5 px-4 rounded-xl text-xs font-bold transition-colors shadow-xs"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 bg-[#0F172A] hover:bg-slate-800 text-[#FFFFFF] py-2.5 px-4 rounded-xl text-xs font-bold tracking-wide shadow-xs transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white py-2.5 px-4 rounded-xl text-xs font-bold tracking-wide transition-colors cursor-pointer shadow-xs"
            >
